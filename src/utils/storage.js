...
export const getTasks = () => {
  const tasks = JSON.parse(localStorage.getItem("tasks")) || [
    ...
    { name: "Research (Chrome)", done: false, timeSpent: 0, requiredTime: 60, incomplete: false, lastCompletedDate: null, status: "pending" },
    { name: "Workout (Youtube) ", done: false, timeSpent: 0, requiredTime: 60, incomplete: false, lastCompletedDate: null, status: "pending" },
    { name: "Classes (Portable)", done: false, timeSpent: 0, requiredTime: 120, incomplete: false, lastCompletedDate: null, status: "pending" },
    ...
    { name: "Applications (Firefox)", done: false, timeSpent: 0, requiredTime: 120, incomplete: false, lastCompletedDate: null, status: "pending" },
